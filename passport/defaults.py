DEFAULT = {
    "schema_version": 1, "enabled": True, "mode": "advisory",
    "change_classes": [
    ...
    "routing": {"technical": "agent", "authority": "human"},
    "evidence_sources": ["pr", "files", "checks", "context", "handoff"],
    "context_paths": [".github/CODEOWNERS", "AGENTS.md", "CLAUDE.md", ".passport/POLICY.md"],
    "required_fields": [], "max_rounds": 8
}
